...
(1, 'admin@fitcenter.com', 'token_admin_demo_001', 'verificacion_email', TRUE, DATE_ADD(NOW(), INTERVAL 1 HOUR)),
(2, 'vendedor@fitcenter.com', 'token_vendedor_demo_001', 'verificacion_email', TRUE, DATE_ADD(NOW(), INTERVAL 1 HOUR)),
(4, 'cliente@fitcenter.com', 'token_cliente_demo_001', 'verificacion_email', TRUE, DATE_ADD(NOW(), INTERVAL 1 HOUR)),

-- Token de prueba para reset de contraseña (no usado) - Cliente María López
(5, 'maria@fitcenter.com', 'reset_token_demo_001', 'reset_password', FALSE, DATE_ADD(NOW(), INTERVAL 2 HOURS));
